...
* 
* The asymptotic running time complexity of this function is O(n), where n is the number of terms in this polynomial object
* 
* The space complexity of this function is S(1), which means the amount of memory used by this function is constant and does not depend on the input size.
*/
void Poly::addMono(int i, double c)
{
...
* 
* The asymptotic running time complexity of this function is O(n^2), where n is the maximum number of terms between the two polynomials being added together.
* 
* The space complexity of this function is S(n) since it only creates temporary nodes and pointers 
*/
void Poly::addPoly(const Poly& p)
{
...
* 
* The asymptotic running time complexity of this function is O(n), where n is the number of terms in the polynomial. 
* 
* The space complexity of this function is S(1) since it only uses temporary variables
*/
void Poly::multiplyMono(int i, double c)
{
	PolyNode* current_node = this->head->next;
...
* 
* The asymptotic running time complexity of this function is O(n^2) where n is the largest number of terms in either the input or current polynomial.
* 
* The space time complexity of this function is S(n^2) since it creates a new linked list for each term in the input polynomial and modifies them
*/
void Poly::multiplyPoly(const Poly& p)
{
	// SANITY CHECK
...
* 
* The asymptotic running time complexity of this function is O(n) where n is the number of terms in the linked list representing a polynomial.
* 
* The space complexity of this function is S(n). This function creates a new polynomial linked list which contains a copy of all of the n terms in the original polynomial linked list.
*/
void Poly::duplicate(Poly& outputPoly)
{
	vector<int> degree;
...
* 
* The asymptotic running time complexity of this function is O(1).
* 
* The space complexity of this function is S(1). This function only requires temporary variables.
*/
int Poly::getDegree()
{
	int degree = -1;
...
* The asymptotic running time complexity of this function is O(n) where n is the number of terms in the linked list representing a polynomial.
* 
* The space complexity of this function is S(1). The function only uses a constant amount of memory for a variable and pointers
*/
int Poly::getTermsNo()
{
	return number_terms;
